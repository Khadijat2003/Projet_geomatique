...
map.getView().fit([-1099084.512845, 3581467.549966, -716907.661105, 3841409.212652], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Carte du recensement de la population de Marrakech-Safi en 2024 ( By Khadijat)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (194 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Projet de realisation d\'une carte choroplethe interactive basee sur la variation de la population les differentes provinces de la region de Marrakech-Safi selon le recensement de septembre 2024.';
            }
